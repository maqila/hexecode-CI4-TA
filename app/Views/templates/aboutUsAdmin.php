...
<body>
  ...
  <section class="py-5">
    <div class="container">
      <div class="row align-items-center g-5">
        <div class="col-md-6">
          <img src="<?= base_url('assets/images/about/about1.jpg') ?>" alt="Teater Illustration" class="about-image">
        </div>
        <div class="col-md-6">
  ...
  <section class="text-center py-5 bg-light">
    <div class="container">
      ...
      <a href="#" class="btn btn-primary px-4 py-2 mt-2">Pesan Tiket Sekarang</a>
    </div>
  </section>
