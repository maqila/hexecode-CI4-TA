    ...
    <div class="list-penampilan">
            ...
            <div class="show-item">
                ...
                <div class="show-info">
                    ...
                    <div class="details">
                        ...
                        <p><span class="label">Sinopsis: </span> Disebuah hutan, tinggallah bayi kera yang sangat cantik. Saat beranjak remaja, ia berjalan menuju desa manusia.</p>
                        <p><span class="label">Sosial Media:</span> Instagram @eslilincilacapproduction, Facebook 'Es Lilin Cilacap Production'</p>
                        <p><span class="label">Web:</span> www.nsi.com (Komunitas Teater Official), www.liliputdalamtulip.com (Teater Official)</p>
                    </div>
        ...
        <div id="showPopup" class="popup">
            <div class="popup-content">
                ...
                <form id="showForm" action="<?= base_url('saveShow') ?>" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="schedule-show">
                                        ...
                                        <div id="nominal-harga" style="display:none;">
                                            ...
                                            <div id="seat-config" style="display:none;">
                                                ...
                                                <input type="file" name="denah_seat" id="denah_seat" class="form-control" accept="image/*" placeholder="Upload denah tempat duduk">
                                            </div>
                                        </div>
