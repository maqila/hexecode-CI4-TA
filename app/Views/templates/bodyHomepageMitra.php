                        ...
                        <div class="container">
                            <div class="slide-content">
                                ...
                                <div class="slider-btns">
                                    <a href="team.html" class="theme-btn">Cek Jadwal</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="page-content">
                    <div class="row">
                        <div class="col-xxl-9">
                            <div class="row">
                                <div class="col-xl-4">
                                    <a href="<?= base_url('Admin/listPenampilan') ?>" class="card bg-success-subtle text-decoration-none">
                                        <div class="card-body">
                                            <div class="d-flex">
                                ...
                                <div class="col-xl-4">
                                    <a href="<?= base_url('Admin/listAudisi') ?>" class="card bg-warning-subtle text-decoration-none">
                                        <div class="card-body">
                                            <div class="d-flex">
